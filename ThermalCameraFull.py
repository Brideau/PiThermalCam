...
def start_server(output_folder = '/home/brideau/'):
	global thermcam
	# initialize the video stream and allow the camera sensor to warmup
	thermcam = pithermalcam(output_folder=output_folder, use_f=False)
	time.sleep(0.1)

	GPIO.add_event_detect(25, GPIO.RISING, callback=save_image_button)
